  ...
  return (
    <div className='bg-white shadow-md p-5 rounded-md mb-3 uppercase'>
      ...
      <section className='flex flex-col lg:flex-row justify-between gap-3 mt-10'>
        ...
        <button type='button' className='bg-red-600 hover:bg-red-700 text-white rounded-lg py-2 px-10 font-bold uppercase' onClick={()=>deletePatient(patient.id)}>Eliminar</button>
      </section>
    </div>
